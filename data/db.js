...
(function() {
    ...
    var endpointSelector = new DevExpress.EndpointSelector(RY.config.endpoints);
    var serviceConfig = $.extend(true, {}, RY.config.services, {
        db: {
    ...
    RY.db = new DevExpress.data.ODataContext(serviceConfig.db);
